<div class="entityLinksContainer d-flex flex-row flex-md-column mt-3 mt-md-0">
	<?php if ($apiResult["data"]["type"] == "person" || $apiResult["data"]["type"] == "organisation" || $apiResult["data"]["type"] == "term") { ?>
		<div class="text-right">
			<a class="btn btn-sm me-2 me-md-0 mb-0 mb-md-2" href="https://wikidata.org/wiki/<?= $apiResult["data"]["id"] ?>" target="_blank">
	...
	<?php } else if (isset($apiResult["data"]["attributes"]["wikidataID"])) { ?>
		<div class="text-right">
			<a class="btn btn-sm me-2 me-md-0 text-right mb-0 mb-md-2" href="https://wikidata.org/wiki/<?= $apiResult["data"]["attributes"]["wikidataID"] ?>" target="_blank">
				<span>Wikidata</span><img class="ms-2" src="<?= $config["dir"]["root"] ?>/content/client/images/logos/wikidata-sm.png">
			</a>
		</div>
	<?php } ?>
	<?php if (isset($apiResult["data"]["attributes"]["additionalInformation"]["abgeordnetenwatchID"])) { ?>
		<div class="text-right">
			<a class="btn btn-sm me-2 me-md-0 text-right mb-0 mb-md-2" href="https://abgeordnetenwatch.de/politician/<?= $apiResult["data"]["attributes"]["additionalInformation"]["abgeordnetenwatchID"] ?>" target="_blank">
