		...
		<div class="row" style="position: relative; z-index: 1">
			<div class="col-12">
				<div class="row">
					...
					<div class="col">
						<h3 class="mb-0" style="white-space: normal;"><?= $entity["data"]["attributes"]["label"] ?></h3>
						<?php
						if (isset($entity["data"]["attributes"]["labelAlternative"]) && !empty($entity["data"]["attributes"]["labelAlternative"])) { ?>
							<div class="less-opacity"><?= implode(', ', $entity["data"]["attributes"]["labelAlternative"]) ?></div>
						<?php 
						}
						...
						<div class="mt-2">
							...
							if ($entity["data"]["type"] == "person" || $entity["data"]["type"] == "organisation" || $entity["data"]["type"] == "term") { ?>
								<a class="btn btn-sm me-2 mb-2" href="https://wikidata.org/wiki/<?= $entity["data"]["id"] ?>" target="_blank">
							...
							<?php } else if (isset($entity["data"]["attributes"]["wikidataID"])) { ?>
								<a class="btn btn-sm me-2 mb-2" href="https://wikidata.org/wiki/<?= $entity["data"]["attributes"]["wikidataID"] ?>" target="_blank">
									<span>Wikidata</span><img class="ms-2" src="<?= $config["dir"]["root"] ?>/content/client/images/logos/wikidata-sm.png">
								</a>
							<?php }
							...
							if (isset($entity["data"]["attributes"]["additionalInformation"]["wikipedia"]["url"])) { ?>
								<a class="btn btn-sm me-2 mb-2" href="<?= $entity["data"]["attributes"]["additionalInformation"]["wikipedia"]["url"] ?>" target="_blank">
							...
							if (isset($entity["data"]["attributes"]["additionalInformation"]["abgeordnetenwatchID"])) { ?>
								<a class="btn btn-sm me-2 mb-2" href="https://abgeordnetenwatch.de/politician/<?= $entity["data"]["attributes"]["additionalInformation"]["abgeordnetenwatchID"] ?>" target="_blank">
							...
							if (isset($entity["data"]["attributes"]["websiteURI"]) && !empty($entity["data"]["attributes"]["websiteURI"])) { ?>
								<a class="btn btn-sm me-2 mb-2" href="<?= $entity["data"]["attributes"]["websiteURI"] ?>" target="_blank">
							...
							if (isset($entity["data"]["attributes"]["socialMediaIDs"]) && !empty($entity["data"]["attributes"]["socialMediaIDs"])) {
								foreach ($entity["data"]["attributes"]["socialMediaIDs"] as $social) { ?>
									<a class="btn btn-sm me-2 mb-2" href="<?= $social['id'] ?>" target="_blank">
										<span class="icon-link"></span> <?= ucfirst($social['label']) ?>
									</a>
								<?php }
							} ?>
						</div>
