					...
					<div class="entityContainer">
						<div class="linkWrapper">
							...
							<div>
								...
								<div><span class="icon-angle-right"></span>Entwicklerin: Named Entity Linking</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="entityContainer">
						<div class="linkWrapper">
							...
							<div>
								...
								<div>Backend Entwickler & Designer</div>
								<div><span class="icon-angle-right"></span>Plattform-Architektur & -Administration</div>
							</div>
						</div>
					</div>
				</div>
