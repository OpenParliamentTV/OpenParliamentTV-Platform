...
<main class="container subpage">
	...
	<div class="row">
		<div class="col-12 col-lg-8">
			...
			<a href="https://openparliament.tv" target="_blank" class="btn btn-primary btn-sm d-block"><span class="icon-right-open-big mr-1"></span> Mehr zur Vision, Mission, Strategie und Anwendungsbereichen von Open Parliament TV</a>
			<hr>
			<h3>Open Data</h3>
