				...
				<div class="detailsLayoutContainer">
					<div class="detailsLayoutThumbnail detailsThumbnailContainer">
						<div class="rounded-circle">
							...
							<?php } else { ?>
								<span class="icon-type-document" style="position: absolute;top: 48%;left: 50%;font-size: 50px;transform: translateX(-50%) translateY(-50%);"></span>
							<?php } ?>
						</div>
						<?php if ($apiResult["data"]["attributes"]["thumbnailURI"]) { ?>
					...
					<?php if (($apiResult["data"]["attributes"]["abstract"] && $apiResult["data"]["attributes"]["abstract"] != "undefined") || $apiResult["data"]["attributes"]["sourceURI"]) { ?>
					<div class="detailsLayoutAbstract">
						...
						<?php if ($apiResult["data"]["attributes"]["sourceURI"]) { ?>
							<a class="btn btn-sm me-2 mt-2 col-12 col-sm-auto" href="<?= hAttr($apiResult["data"]["attributes"]["sourceURI"]) ?>" target="_blank">
