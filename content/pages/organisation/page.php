	...
	<div class="row">
		<div class="col-12">
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link" id="people-tab" data-toggle="tab" href="#people" role="tab" aria-controls="people" aria-selected="false"><span class="icon-torso"></span> <?php echo L::personPlural ?></a>
				</li>
