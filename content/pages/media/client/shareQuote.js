...
function initShareQuote() {
	...
	const selectionShare = shareThis({
		...
		sharers: [{
			'render': function() {
				return '<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#shareQuoteModal"><span class="icon-share"></span> '+ localizedLabels.shareQuote +'</button>'
			},
			'name': 'OPTV' 
		}]
	});
