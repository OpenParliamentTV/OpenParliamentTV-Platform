				...
				<div class="detailsLayoutContainer">
					<div class="detailsLayoutThumbnail detailsThumbnailContainer">
						<div class="rounded-circle">
							...
							<?php } else { ?>
								<span class="icon-type-person" style="position: absolute;top: 48%;left: 50%;font-size: 50px;transform: translateX(-50%) translateY(-50%);"></span>
							<?php } ?>
						</div>
						<?php if ($apiResult["data"]["attributes"]["thumbnailURI"]) { ?>
		...
		<div class="col-12">
			<ul class="nav nav-tabs modern-tabs" role="tablist">
				...
				<?php if ($config["display"]["ner"]) { ?>
					<li class="nav-item">
						<a class="nav-link" id="ner-tab" data-bs-toggle="tab" data-bs-target="#ner" role="tab" aria-controls="ner" aria-selected="true"><span class="icon-annotations"></span><span class="nav-item-label"><?= L::automaticallyDetectedInSpeeches() ?><span class="betaWarning" data-bs-toggle="modal" data-bs-target="#nerModal"><span class="icon-attention me-1"></span><u>beta</u></span></span></a>
					</li>
				<?php } ?>
