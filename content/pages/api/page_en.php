	...
	<div class="row" style="position: relative; z-index: 1">
		<div class="col-12">
			...
			<ul class="nav nav-tabs" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" id="search-tab" data-bs-toggle="tab" data-bs-target="#search" role="tab" aria-controls="search" aria-selected="true"><span class="nav-item-label">Search</span></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="entities-tab" data-bs-toggle="tab" data-bs-target="#entities" role="tab" aria-controls="entities" aria-selected="true"><span class="nav-item-label">Entities</span></a>
				</li>
				<li class="nav-item">
			...
			<div class="tab-content">
				<div class="tab-pane fade bg-white show active" id="search" role="tabpanel" aria-labelledby="search-tab">
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade bg-white" id="terms" role="tabpanel" aria-labelledby="terms-tab">
							...
							<hr>
							<h3><?php echo L::example; ?> Request</h3>
							<div>(<?php echo L::terms; ?> with label "digital")</div>
							<div class="apiExampleContainer">
								<div class="input-group">
									<span class="input-group-text">URI</span>
				...
				<div class="tab-pane fade bg-white" id="entities" role="tabpanel" aria-labelledby="entities-tab">
					...
					<p class="mb-2"><b><?php echo L::term; ?> IDs</b> are <b>always a Wikidata ID</b>.</p>
