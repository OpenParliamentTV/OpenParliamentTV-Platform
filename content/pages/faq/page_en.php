...
<main class="container subpage">
	<div class="row" style="position: relative; z-index: 1">
		<div class="col-12">
			...
			<div class="accordion my-3" id="accordion">
				<div class="card" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					...
					<div id="a1" class="collapse" aria-labelledby="q1" data-parent="#accordion" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
						<div class="card-body" itemprop="text">You can find more information on the people behind the project at <a href="about#team">About the Project > Team</a>. Wir befinden uns im Moment in der Gründungsphase einer gemeinnützigen GmbH, welche in Zukunft Open Parliament TV als nicht-kommerzielles Projekt betreiben und weiterentwickeln soll. <br><br>Mehr unter der Frage: <i>How are you financed?</i></div>
					</div>
				</div>
				<div class="card" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
			...
			<div class="alert alert-info mt-4">Frage nicht beantwortet? Kontaktiere uns gerne jederzeit per Mail unter joscha.jaeger [at] openparliament.tv oder per Twitter: @OpenParlTV.</div>
		</div>
	</div>
</main>
