...
$paramStr = "";
$allowedParams = array_intersect_key($_REQUEST,array_flip(array("q","name","person","personID","context","party","partyID","faction","factionID","organisation","organisationID","electoralPeriod","dateFrom","dateTo","gender","degree","abgeordnetenwatchID","speakerID","sessionNumber","documentID","playresults", "page", "sort")));
$paramCount = 1;
