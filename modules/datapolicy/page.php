...
<main class="container subpage">
	<div class="row" style="position: relative; z-index: 1">
		<div class="col-12">
			...
			<p>Auf der Webseite OpenParliament.TV sowie den parlamentspezifischen Unterseiten (z.B. de.openparliament.tv) können Sie Reden im Deutschen Bundestag in Kombination mit den Parlamentsprotokollen und zusätzlichen Informationen (relevante Drucksachen, Abgeordnetenprofile auf abgeordnetenwatch.de) abrufen und durchsuchen.</p>
			<hr>
			<h3>1. Bei der Verwendung der Seite werden Zugriffsdaten ausschließlich zur Optimierung und Verbesserung des Angebots gespeichert (Zweckbindung).</h3>
			...
			<hr>
			<h3>2. Übermittlung von Daten an Dritte</h3>
			<h4>2.1. Übermittlung im Rahmen der <b>[ABGEORDNETENWATCH, BUNDESTAG, VIDEODIENSTLEISTER]</b></h4>
			<p><b>[BESCHREIBUNG]</b></p>
			<h4>2.2. Keine Übermittlung an Dritte zu Werbezwecken ohne ausdrückliche Einwilligung</h4>
			...
			<h4>2.3 Auskunftsanordnungen</h4>
			...
			<hr>
			<h3>3. Abrufbarkeit der Datenschutzerklärung</h3>
			...
			<hr>
			<h3>4. Fragen, Auskunftsrecht, Widerspruchsrechte und Profiling</h3>
			...
			<hr>
			<p>Wenn Sie Fragen haben, die Ihnen diese Datenschutzerklärung nicht beantworten konnte oder wenn Sie zu einem Punkt vertiefte Informationen wünschen, wenden Sie sich bitte jederzeit an&nbsp;<a href="mailto:[MAIL]"><b>[MAIL]</b></a>.</p>
			<hr>
