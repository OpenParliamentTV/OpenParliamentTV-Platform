	...
	<div class="row">
		<div class="col-12 col-lg-8 col-xl-8">
			...
			<div style="float: left; padding: 15px 10px 0px 10px">
				...
				<div class="partnerLogos">
					<!--<img src="client/images/logos/zeit-online.png" style="height: 21px; margin-top: 0px;">-->
					<div class="clearfix"></div>
				</div>
			</div>
		</div>
		...
		<div class="col-12 col-lg-4 col-xl-4">
			<div class="d-flex align-content-end">
				<img class="ml-auto align-self-center" src="client/images/logos/okfde.svg" style="height: 100px; margin-top: 0px;">
